...
export default function Paquetes() {
  const caracteristicas = [
    {
      titulo: "Secciones",
      basico: "1 Sección",
      intermedio: "3 Secciones",
      pro: "Ilimitadas Secciones",
      descripcion:
    ...
    },
    {
      ...
      basico: "No incluido",
      intermedio: "Optimización básica",
  ...
  const paquetes = [
    ...
    },
    {
      ...
      subtitulo: "Perfecto para crecer tu negocio",
      nombre: "avanzado",
      precio: "INTERMEDIO $150 MIL PESOS",
      caracteristicas: caracteristicas.map((caracteristica) => ({
        titulo: caracteristica.titulo,
        valor: caracteristica.intermedio,
        descripcion: caracteristica.descripcion,
      })),
    },
    {
