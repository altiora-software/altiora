...
const NewsPage = () => {
  ...
  const news = blogPosts.find(post => post.id === parseInt(id));
  ...
  return (
    <div className="container mx-auto px-4">
      ...
      <img className="w-full mb-8" src={news.image} alt={news.title} />
      <p className="text-gray-600 text-sm mb-4">{news.date} - {news.category}</p>
      <p>{news.content}</p>
      <div className="mt-8">
        <Link href="/blog">
          Volver al blog
