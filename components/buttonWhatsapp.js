...
const ChatWhatsapp = () => {
  ...
  return (
    <button
      ...
      className={`fixed z-40 flex items-center justify-center transition duration-300 rounded-full shadow-lg right-5 bottom-8 w-14 h-14 borderfocus:outline-none  text-white bg-[#25D366] ease`}
    >
